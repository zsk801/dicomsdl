...
#
# DICOM Software Development Library documentation build configuration file, created by
...
project = u'DICOM Software Development Library'
copyright = u'2010, Kim, Tae-Sung'
...
htmlhelp_basename = 'DICOMSoftwareDevelopmentLibrarydoc'
...
man_pages = [
    ('index', 'dicomsoftwaredevelopmentlibrary', u'DICOM Software Development Library Documentation',
     [u'Kim, Tae-Sung'], 1)
]
